...
zephyr_get(APPLICATION_SOC_DIR SYSBUILD GLOBAL)
set_ifndef(APPLICATION_SOC_DIR ${APPLICATION_CONFIG_DIR})
zephyr_get(APPLICATION_BOARD_DIR SYSBUILD GLOBAL)
set_ifndef(APPLICATION_BOARD_DIR ${APPLICATION_CONFIG_DIR})
...
if(NOT DEFINED CONF_FILE)
  ...
  zephyr_file(CONF_FILES ${APPLICATION_SOC_DIR}/socs KCONF CONF_FILE QUALIFIERS SUFFIX ${FILE_SUFFIX})
  zephyr_file(CONF_FILES ${APPLICATION_BOARD_DIR}/boards KCONF CONF_FILE SUFFIX ${FILE_SUFFIX})
else()
...
if(NOT DEFINED DTC_OVERLAY_FILE)
  zephyr_file(CONF_FILES ${APPLICATION_SOC_DIR}/socs DTS DTC_OVERLAY_FILE QUALIFIERS SUFFIX ${FILE_SUFFIX})
  zephyr_file(CONF_FILES ${APPLICATION_BOARD_DIR}/boards DTS DTC_OVERLAY_FILE SUFFIX ${FILE_SUFFIX})
endif()
